...
class word{
    ...
    List<String> words_H = new ArrayList<>(Arrays.asList(""));
    List<String> words_M = new ArrayList<>(Arrays.asList());
    List<String> words_Y = new ArrayList<>(Arrays.asList());
    List<String> words_R = new ArrayList<>(Arrays.asList());
}